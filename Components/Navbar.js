...
const Navbar = () => {
  ...
  return (
    <>
      <div className="navbar flex items-center justify-between bg-transparent backdrop-blur-[5px] h-[60px] pb-[10px] px-13 top-0 fixed w-full z-[999]">
        <div className="cursor-pointer logo mt-[20px]">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
        ...
        <div className="links flex items-center gap-9  mt-[30px]">
          {["Services", "Our work", "About us", "Insights", "Contact us"].map(
            (item, index) => {
              return (
                <motion.div
                  className=" h-[18.9999999px] w-fit leading-none overflow-hidden "
                  key={index}
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{
                ...
                >
                  <motion.h2
                    ...
                    initial={{ y: "0%" }}
                    animate={navLink[index]}
                    key={index}
                    className={`${
                      index === 4 && "ml-65 "
                    } text-[1.11vw] font-[Neue_Montreal] cursor-pointer w-fit `}
                  >
                    {item}
                  </motion.h2>
                  ...
                  <motion.h2
                    ...
                    className={`${
                      index === 4 && "ml-65"
                    } text-[1.11vw] font-[Neue_Montreal] cursor-pointer `}
                  >
                    {item}
                  </motion.h2>
                </motion.div>
